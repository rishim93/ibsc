...
from ibsc.core.views import core
from ibsc.users.views import users
from ibsc.blog_posts.views import blog_posts
from ibsc.error_pages.handlers import error_pages
